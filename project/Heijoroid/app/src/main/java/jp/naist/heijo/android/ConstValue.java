...
public class ConstValue
{
  ...
  public static final String THIS_PACKAGE_NAME = "jp.naist.heijo.android";

  public static final String LOG_TAG = "Heijoroid";
  ...
  public static final String BUNDLE_IGNORE_PACKAGE_NAMES = THIS_PACKAGE_NAME + ".IGNORE_PACKAGE_NAMES";
